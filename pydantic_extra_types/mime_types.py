...
class Application(StrEnum):
    ...
    APPLICATION_VND_ARASTRA_SWI = "application/vnd.arastra.swi"  # OBSOLETED in favor of application/vnd.aristanetworks.swi
    ...
    APPLICATION_VND_INFORMIX_VISIONARY = "application/vnd.informix-visionary"  # OBSOLETED in favor of application/vnd.visionary
    ...
    APPLICATION_VND_NOKIA_N_GAGE_SYMBIAN_INSTALL = "application/vnd.nokia.n-gage.symbian.install"  # OBSOLETE; no replacement given
    ...
    APPLICATION_VND_OASIS_OPENDOCUMENT_DATABASE = "application/vnd.oasis.opendocument.database"  # OBSOLETED in favor of application/vnd.oasis.opendocument.base
